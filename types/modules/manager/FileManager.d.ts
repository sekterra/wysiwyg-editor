...
declare class FileManager {
     ...
     */
    upload(uploadUrl: string, uploadHeader: {
        [x: string]: string;
    } | null, data: FileList | File[] | {
        formData: FormData;
        size: number;
    }, callBack?: ((xmlHttp: XMLHttpRequest) => boolean) | null, errorCallBack?: ((res: any, xmlHttp: XMLHttpRequest) => string) | null): void;
    /**
     * @description Upload the file to the server.
     * @param {string} uploadUrl Upload server url
     * @param {?Object<string, string>} uploadHeader Request header
     ...
     */
    asyncUpload(uploadUrl: string, uploadHeader: {
        [x: string]: string;
    } | null, data: FileList | File[] | {
        formData: FormData;
        size: number;
     ...
     */
    setFileData(element: Node, { name, size }: {
        name: string;
        size: number;
    }): void;
    /**
