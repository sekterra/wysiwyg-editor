...
declare class Figure {
     ...
     */
    static GetRatio(w: string | number, h: string | number, defaultSizeUnit?: string | null): {
        w: number;
        h: number;
    };
    /**
     ...
     */
    static CalcRatio(w: string | number, h: string | number, defaultSizeUnit: string, ratio?: {
        w: number;
        h: number;
    } | null): {
        w: string | number;
     ...
     */
    open(targetNode: Node, { nonResizing, nonSizeInfo, nonBorder, figureTarget, infoOnly }: {
        nonResizing?: boolean;
        nonSizeInfo?: boolean;
        nonBorder?: boolean;
     ...
     */
    controllerOpen(target: Node, params?: {
        isWWTarget?: boolean;
        initMethod?: () => void;
        disabled?: boolean;
        addOffset?: {
