 ...
 */
export function makePorts(inst: EventManagerInstanceType, { _styleNodes }: {
    _styleNodes: any;
}): {
    focusManager: {
        nativeFocus: () => void;
    ...
    listFormat: {
        applyNested: (cells: any, shift: any) => {
            sc: Node;
            so: number;
            ec: Node;
            eo: number;
    ...
    nodeTransform: {
        removeAllParents: (s: any, n: any, p: any) => {
            sc: Node | null;
            ec: Node | null;
        };
