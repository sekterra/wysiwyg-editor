...
export type StoreState = {
	...
	/**
	 * - Preserve expanded selection across toolbar interactions.
	 */
	_toolbarPreserveSelection: boolean;
	/**
	 * - Snapshot of multi-selected table cells for bulk-format commands.
	 */
	_tableMultiCellFormatSnapshot: Array<HTMLTableCellElement> | null;
};
/**
