...
declare class Offset {
     ...
     */
    setRelPosition(element: HTMLElement, e_container: HTMLElement, target: HTMLElement, t_container: HTMLElement, { preferUp }?: {
        preferUp?: boolean;
    }): void;
    /**
     ...
     * });
     */
    setAbsPosition(element: HTMLElement, target: HTMLElement, params: {
        isWWTarget?: boolean;
        addOffset?: {
            left: number;
            right: number;
     ...
     */
    setRangePosition(element: HTMLElement, range: Range | null, { position, addTop }?: {
        position?: "bottom" | "top";
        addTop?: number;
    }): boolean;
    #private;
