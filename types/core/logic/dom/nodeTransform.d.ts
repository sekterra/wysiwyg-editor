...
declare class NodeTransform {
     ...
     */
    removeAllParents(item: Node, validation?: ((current: Node) => boolean) | null, stopParent?: Node | null): {
        sc: Node | null;
        ec: Node | null;
    } | null;
    /**
     ...
     */
    createNestedNode(nodeArray: SunEditor.NodeCollection, validate?: ((current: Node) => boolean) | null): {
        parent: Node;
        inner: Node;
    };
    #private;
