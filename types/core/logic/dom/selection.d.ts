...
declare class Selection_ {
     ...
     */
    snapshotExpandedRangeIfLive(): boolean;
    /**
     ...
     */
    getRects(target: (Range | Node) | null, position: "start" | "end"): {
     ...
     * });
     */
    scrollTo(ref: Selection | Range | Node, scrollOption?: ScrollIntoViewOptions & {
        noFocus?: boolean;
    }): void;
    /**
