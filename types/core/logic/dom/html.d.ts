...
declare class HTML {
     ...
     * });
     */
    filter(html: string, { tagWhitelist, tagBlacklist, validate, validateAll }: {
        tagWhitelist?: string;
        tagBlacklist?: string;
     ...
     * });
     */
    clean(html: string, { forceFormat, whitelist, blacklist, _freeCodeViewMode }?: {
        forceFormat?: boolean;
     ...
     */
    insert(html: Node | string, { selectInserted, skipCharCount, skipCleaning }?: {
     ...
     */
    insertNode(oNode: Node, { afterNode, skipCharCount }?: {
        afterNode?: Node;
        skipCharCount?: boolean;
    }): any | Node | null;
    /**
