...
declare class ListFormat {
     ...
     */
    apply(type: string, selectedCells: Array<Node>, nested: boolean): {
        sc: Node;
        so: number;
        ec: Node;
        eo: number;
     ...
     */
    remove(selectedCells: Array<Node>, shouldDelete: boolean): {
        sc: Node;
        ec: Node;
    };
    /**
     ...
     */
    applyNested(selectedCells: Array<HTMLElement>, nested: boolean): {
        sc: Node;
        so: number;
        ec: Node;
        eo: number;
