declare namespace _default {
    ...
    function init(init_options: SunEditor.InitOptions): {
        ...
        }, options: SunEditor.InitOptions) => SunEditor.Instance;
    };
    /**
     ...
     */
    function create(target: Element | string | {
        [x: string]: {
            target: Element;
            options: SunEditor.InitFrameOptions;
        };
    }, options: SunEditor.InitOptions, _init_options?: SunEditor.InitOptions): SunEditor.Instance;
}
...
export { plugins, helper, langs, interfaces };
